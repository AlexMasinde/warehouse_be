...
{
    public class ReceiptLineService : IBaseService<IReceiptLine>
    {
        ...
        public IReceiptLine Get(IUser user, int ID)
        {
            throw new NotImplementedException();
        }

        public IReceiptLine Get(IUser user, int[] IDs)
        {
            throw new NotImplementedException();
        }
        ...
        public IList<string> Validate(IReceiptLine t)
        {
            throw new NotImplementedException();
        }
    }
