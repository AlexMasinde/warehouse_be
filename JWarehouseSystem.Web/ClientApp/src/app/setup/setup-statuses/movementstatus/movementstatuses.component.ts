...
@Component({
  selector: 'app-movementstatuses',
  templateUrl: './movementstatuses.component.html',
  styleUrls: ['./movementstatuses.component.scss']
})
export class MovementStatusesComponent implements OnInit {
