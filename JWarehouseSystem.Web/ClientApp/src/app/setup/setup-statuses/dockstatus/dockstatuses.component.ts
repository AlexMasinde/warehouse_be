...
@Component({
  selector: 'app-dockstatuses',
  templateUrl: './dockstatuses.component.html',
  styleUrls: ['./dockstatuses.component.scss']
})
export class DockStatusesComponent implements OnInit {
