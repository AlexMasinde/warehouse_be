...
@Component({
  selector: 'app-productstatuses',
  templateUrl: './productstatuses.component.html',
  styleUrls: ['./productstatuses.component.scss']
})
export class ProductStatusesComponent implements OnInit {
